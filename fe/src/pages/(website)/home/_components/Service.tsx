import { Coin, Safehome, Truckfast } from "@/components/icons";
                    ...
                    <div className="items-start grid lg:grid-cols-[100px_292px] mb:grid-cols-[64px_256px] justify-between">
                        ...
                        <div className="flex flex-col mt-[0.5px] lg:ml-0 mb:ml-0.5">
                            ...
                            <p className="lg:text-base mb:text-[14px] leading-[21px] lg:mt-[19px] mb:mt-[12px] font-normal text-[#717378] lg:leading-auto">
                                ...
                                Shipping right to your doorstep! You can also
                                opt in for shipping insurance. For orders over
                    ...
                    <div className="items-start grid lg:grid-cols-[100px_292px] mb:grid-cols-[64px_256px] justify-between">
                        ...
                        <div className="flex flex-col mt-[0.5px] lg:ml-0 mb:ml-0.5">
                            ...
                            <p className="lg:text-base mb:text-[14px] leading-[21px] lg:mt-[19px] mb:mt-[12px] font-normal text-[#717378] lg:leading-auto">
                                ...
                                quality of our products and service. Our prices
                                are set to ensure you receive your medication at
                                a reasonable price and safely
                            </p>
                        </div>
                    </div>
                </div>
