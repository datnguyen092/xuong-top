                ...
                <div className="relative lg:pt-[323.5px] mb:pt-[238px] lg:w-[1200px] mb:w-[342px] mx-auto">
                    ...
                    <div className="lg:w-[1200px] lg:left-0 lg:translate-x-0 w-full mb:left-1/2 mb:-translate-x-1/2 absolute top-0 -translate-y-1/2">
                        <div className="bg-[#05422C] lg:pb-[70px] px-6 py-[26px] lg:pt-[45px] lg:px-16 rounded-3xl">
                            ...
                            <form
                                action=""
                                className="border-t border-[#346654] lg:pt-8 pt-1 lg:translate-y-2 translate-y-0.5 flex lg:flex-row flex-col lg:gap-y-0 gap-y-[14px] items-center lg:space-x-8"
                            >
                                <input
                                    type="text"
                                    className="w-full border border-[#346654] rounded-full py-4 pr-4 pl-6 lg:py-6 lg:px-11"
                                    placeholder="Email Address"
                                />
                                <button className="btn lg:!h-[72px] lg:w-auto w-full text-left lg:text-center pl-11 py-4 lg:px-[45px] lg:py-6 bg-[#17AF26] whitespace-nowrap text-white rounded-[100px]">
                                    Reveal coupon
                                </button>
                            </form>
                        </div>
                    ...
                    <div className="flex lg:flex-row mb:flex-col lg:gap-x-16 lg:gap-y-0 gap-y-8 *:w-full">
                        <div className="lg:w-[385px]">
                            ...
                            <p className="text-[#9D9EA2] mt-6 font-normal lg:w-full w-[276px]">
                                #1 Canadian top rated online dispensary that
                                meets the customers needs in every single
                                medical marijuana aspect. The team here at
                                TopShelfBC is heavily involved in the Canadian
                                cannabis industry for over 15 years. We strive
                                to provide the top quality products, service and
                        ...
                        <div className="lg:pl-[77px]">
                            ...
                            <div className="mb-4">
                                <h2 className="text-xl text-white uppercase tracking-[0.3px] translate-y-[1px] mb-6">
                                    CONTACT US
                                </h2>
                                <ul>
                                    <li>
                            ...
                            <div className="mt-10">
                                <h2 className="text-xl text-white uppercase mb-[23px]">
                                    More
                                </h2>
                                <ul className="lg:columns-2 *:mb-[13px] lg:gap-x-8">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            className="text-[#9D9EA2] text-sm"
                                        >
                                            Buy weed online in Prince Edward
                                            Island
                                        </a>
                                    </li>
                                    <li>
